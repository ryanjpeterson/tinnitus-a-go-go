          ...
          <div key={svc.name}>
            {svc.url ? (
              <a
                ...
                className="group flex items-start gap-3 rounded border border-border bg-surface-2 px-3 py-2.5 hover:border-accent-lime transition-colors"
              >
              ...
              <div className="flex items-start gap-3 rounded border border-border bg-surface-2 px-3 py-2.5 opacity-60">
